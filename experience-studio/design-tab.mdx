...
The starting state defines how the experience appears when it initially appears on the page. This means that the first message displayed by the experience is set on the Design tab, not the Outline tab.
